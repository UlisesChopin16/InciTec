...
import 'package:incidencias_reportes/barGraph/bar_graph.dart';
...
class _GraficosPageState extends State<GraficosPage> {
  ...
  double metodoPorcentaje(int index){
    return ((getDataController.getDataModelReportes.value.reportes[index].countIdCat * 100) /getDataController.getDataModelReportes.value.cantidadTotal[0].count );
  }
